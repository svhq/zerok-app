...
const steps = [
  {
    number: 1,
    title: 'Deposit',
    shortDesc: 'Enter any amount',
    fullDesc: 'Connect your wallet and deposit any amount of SOL. ZeroK handles the privacy math in the background — you just enter the number and approve.',
    icon: 'deposit',
  ...
  },
  {
    number: 2,
    title: 'Join the Pool',
    shortDesc: 'Anonymity in numbers',
    fullDesc: 'Your deposit joins a shared privacy pool alongside everyone else. As the pool grows, your privacy grows with it. You become one among many.',
    icon: 'wait',
  ...
  },
  {
    number: 3,
    title: 'Withdraw',
    shortDesc: 'Send to any address',
    fullDesc: 'Withdraw to any Solana address, anytime. A zero-knowledge proof proves your right to the funds without linking to your deposit. No on-chain trace.',
    icon: 'withdraw',
